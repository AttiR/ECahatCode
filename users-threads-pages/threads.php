...
if ($method == "POST") {
    ...
    $sql = "INSERT INTO coding_threads (code_thread_title, code_thread_desc, code_thread_cat_id, code_thread_user_id, timestamp) VALUES ('$thread_title', '$thread_desc', '$categoryid', '0', current_timestamp())";
...
if (isset($_GET['categryid'])) {
    ...
    while ($row = mysqli_fetch_assoc($query)) {
        ...
        <div class="d-flex">
            ...
            <div>
                <h5 class="fw-bold">
                    <a style="text-decoration:none" href="thread-detail.php" class="text-dark">
                         ' . $threadname . '</a>
