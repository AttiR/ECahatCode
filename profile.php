            ...
            <div class="card card-prof" style="border:none">
                <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
                    <div class="card card2"
                        style="background: rgba(231, 231, 241, 0.4);padding:2rem; border-bottom: 3px solid purple">
                        <?php
...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']) {
    echo '<div class=" image d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div class=" d-flex mt-2"> <a class="btn btn-dark" style="margin: 2rem auto" href="./userManagement/recover.php">
                                Change Password
                            </a>
                        </div>
                        <div class="text mt-3"> <p style = "margin: auto 2opx; letter-spacing:0.1em">Manage profile, basic information we have saved.

                                <br> Please remember the forum ethics. </p>
                        </div>
